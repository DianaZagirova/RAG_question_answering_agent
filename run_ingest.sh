#!/bin/bash
# Wrapper script to run ingestion with virtual environment
# Usage: ./run_ingest.sh --limit 100 --reset
...
echo -e "${BLUE}=================================="
echo "RAG Agent Ingestion Wrapper"
echo -e "==================================${NC}"
echo ""
...
# Run the ingestion script with all arguments passed through
python src/ingestion/ingest_optimal.py "$@"
